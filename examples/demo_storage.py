...
def demo_transactions():
    ...
    try:
        ...
        delta_table.write(
            HiveDataFrame([{'account_id': 'A003', 'owner': 'Carol', 'balance': 750}]),
            mode='append'
        )
...
def demo_performance():
    ...
    try:
        ...
        for size in sizes:
            ...
            print(f"  ------------|------------|-----------|----------")
            print(f"  Parquet     | {parquet_write*1000:>10.2f} | {parquet_read*1000:>9.2f} | {parquet_size:>8.2f}")
            print(f"  Delta Lake  | {delta_write*1000:>10.2f} | {delta_read*1000:>9.2f} | {delta_size:>8.2f}")
