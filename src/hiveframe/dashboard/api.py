        ...
        if self.hive and hasattr(self.hive, 'bees'):
            ...
            for bee in self.hive.bees:
                info = WorkerInfo(
                    ...
                    current_partition=bee.current_source.partition_id if bee.current_source else None,
        ...
        for worker in self.workers_panel.workers:
            if worker.worker_id == worker_id:
                return APIResponse(success=True, data={
                    ...
                    'lastActive': worker.last_active.isoformat() if worker.last_active else None,
                })
