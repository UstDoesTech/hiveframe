...
class SwarmPrefetcher:
    ...
    def __init__(
        ...
        self._pattern_counts: Dict[Tuple[str, ...], Dict[str, int]] = defaultdict(lambda: defaultdict(int))
        self._lock = threading.Lock()
...
class CachingSwarm:
    ...
    def __init__(
        self,
        num_nodes: int = 8,
        max_size_per_node: int = 100 * 1024 * 1024
    ):
