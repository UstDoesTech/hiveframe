...
class FeatureHive:
    ...
    def list_features(self, tags: Optional[Set[str]] = None) -> List[str]:
        ...
        if tags:
            features = [name for name in features if self._features[name].tags & tags]

        return sorted(features)

    def get_features(
        self, feature_names: List[str], entity_ids: List[Any], use_cache: bool = True
    ) -> Dict[str, List[Any]]:
        """
    ...
    def set_feature_values(self, feature_name: str, entity_values: Dict[Any, Any]) -> None:
        """
    ...
    def create_feature_group(
        self, name: str, features: List[str], description: Optional[str] = None
    ) -> FeatureGroup:
        """
        ...
        group = FeatureGroup(name=name, features=features, description=description)
    ...
    def get_group_features(
        self, group_name: str, entity_ids: List[Any], use_cache: bool = True
    ) -> Dict[str, List[Any]]:
        """
    ...
    def invalidate_cache(
        self, feature_name: Optional[str] = None, entity_id: Optional[Any] = None
    ) -> None:
        """
