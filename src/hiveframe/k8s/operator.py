...
class HiveOperator:
    ...
    def uninstall(self) -> None:
        ...
        # Delete operator
        self._kubectl(
            'delete', 'deployment', 'hiveframe-operator',
        ...
        self._kubectl(
            'delete', 'serviceaccount', 'hiveframe-operator',
            '-n', self.config.namespace,
            '--ignore-not-found'
        )
    ...
    def scale(self, 
              name: str, 
              replicas: int,
              namespace: str = "default") -> ClusterStatus:
        """
        Scale a cluster.
        ...
        result = self._kubectl(
            'scale', 'deployment', f'{name}-workers',
            f'--replicas={replicas}',
            '-n', namespace
        )
    ...
    def get_logs(self, 
        ...
        result = self._kubectl(
            'logs',
            f'-l', f'app.kubernetes.io/instance={name}',
            '-n', namespace,
            f'--tail={tail}',
            '--all-containers'
        )
