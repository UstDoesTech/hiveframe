...
class UsageAnalyzer:
    ...
    def _find_peak_hours(self, hourly_avg: Dict[int, float], threshold_factor: float = 1.3) -> List[int]:
    ...
    def _find_low_hours(self, hourly_avg: Dict[int, float], threshold_factor: float = 0.7) -> List[int]:
