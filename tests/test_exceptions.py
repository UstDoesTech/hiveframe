...
from hiveframe.exceptions import (
    # Base and enums
    HiveFrameError, ErrorSeverity, ErrorCategory,
    # Transient errors
    TransientError, NetworkError, TimeoutError, RateLimitError,
    ConnectionError as HiveConnectionError,
    # Data errors
    DataError, ValidationError, SchemaError, ParseError,
    EncodingError, NullValueError,
    # Resource errors
    ResourceError, MemoryError as HiveMemoryError,
    DiskSpaceError, ConnectionPoolExhausted, WorkerExhausted,
    # Configuration errors
    ConfigurationError, InvalidParameterError, MissingConfigError,
    # Dependency errors
    DependencyError, ServiceUnavailable, CircuitOpenError, UpstreamError,
    # Processing errors
    ProcessingError, TransformError, AggregationError, JoinError,
    # DLQ
    DeadLetterRecord, DeadLetterQueue
)
...
class TestResourceErrors:
    ...
    def test_memory_error(self):
        ...
        error = HiveMemoryError(
            ...
            available_bytes=536870912    # 512MB
        )
