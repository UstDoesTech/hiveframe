...
class TestRetryPolicy:
    ...
    def test_exponential_backoff(self):
        ...
        policy = RetryPolicy(
            max_retries=3, base_delay=0.1, strategy=BackoffStrategy.EXPONENTIAL, jitter=False
        )
    ...
    def test_linear_backoff(self):
        ...
        policy = RetryPolicy(
            max_retries=3, base_delay=0.1, strategy=BackoffStrategy.LINEAR, jitter=False
        )
...
class TestCircuitBreaker:
    ...
    def test_circuit_closes_on_success(self):
        ...
        config = CircuitBreakerConfig(failure_threshold=1, success_threshold=1, timeout=0.05)
        circuit = CircuitBreaker("test", config)
