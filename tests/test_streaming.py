...
class TestStreamRecord:
    ...
    def test_record_creation(self):
        ...
        record = StreamRecord(key="user_1", value={"action": "click"}, timestamp=time.time())
    ...
    def test_record_with_custom_timestamp(self):
        ...
        ts = 1700000000.0
        record = StreamRecord(key="key", value="value", timestamp=ts)
...
class TestEnhancedStreamProcessor:
    ...
    def test_process_record(self):
        ...
        processor = EnhancedStreamProcessor(num_workers=2, window_assigner=tumbling_window(5.0))

        record = StreamRecord(key="sensor_1", value=42.0, timestamp=time.time())
    ...
    def test_window_aggregation(self):
        ...
        for i in range(5):
            record = StreamRecord(key="key", value=10.0, timestamp=base_time + i * 0.1)
...
class TestCheckpointing:
    ...
    def test_checkpoint_creation(self):
        ...
        checkpoint = Checkpoint(checkpoint_id=1, timestamp=time.time(), state={"counter": 100})
    ...
    def test_state_backend(self):
        ...
        # Save checkpoint
        checkpoint = Checkpoint(checkpoint_id=1, timestamp=time.time(), state={"key": "value"})
