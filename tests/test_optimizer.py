...
class TestCostModel:
    ...
    def test_scan_cost(self):
        ...
        stats = {
            'table1': Statistics(row_count=10000, avg_row_size=100)
        }
        
        scan_node = PlanNode(
            node_type=NodeType.SCAN,
            properties={'table': 'table1'}
        )
    ...
    def test_filter_reduces_rows(self):
        ...
        model = SwarmCostModel()
        stats = {
            'table1': Statistics(row_count=10000)
        }
