...
class TestHistogram:
    ...
    def test_histogram_custom_buckets(self):
        ...
        hist = Histogram("custom_hist", buckets=(0.1, 0.5, 1.0, float("inf")))
...
class TestLogRecord:
    ...
    def test_log_record_creation(self):
        ...
        record = LogRecord(
            timestamp=time.time(), level=LogLevel.INFO, message="Test message", logger_name="test"
        )
...
class TestBufferedHandler:
    ...
    def test_buffered_handler_stores_logs(self):
        ...
        record = LogRecord(
            timestamp=time.time(), level=LogLevel.INFO, message="Test", logger_name="test"
        )
...
class TestTracer:
    ...
    def test_start_child_span(self):
        ...
        child = tracer.start_span(parent.trace_id, "child_op", parent_span_id=parent.span_id)
